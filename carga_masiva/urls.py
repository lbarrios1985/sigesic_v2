...
from .ajax import descargar_archivo, descargar_archivo_apoyo, cargar_datos, retornar_archivo
...
urlpatterns = [
    ...
    url(r'^ajax/retornar_archivo/?$', retornar_archivo, name='cm_retornar_archivo'),
]
