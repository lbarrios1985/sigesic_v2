...
"""
## @namespace unidad_economica.sucursal.views
#
...
class SucursalCreate(SuccessMessageMixin,CreateView):
    """!
    Clase que registra las sucursales
    ...
    success_url = reverse_lazy('sucursal_create')
    ...
    def get_initial(self):
        ...
        datos_iniciales = super(SucursalCreate, self).get_initial()
