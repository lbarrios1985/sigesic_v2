...
"""
## @package unidadeconomica.apps
#
# Clases, atributos y métodos para la configuración del módulo unidadeconomica
...
class UnidadeconomicaConfig(AppConfig):
    name = 'unidadeconomica'
